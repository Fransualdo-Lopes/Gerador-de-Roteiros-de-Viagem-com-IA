...
export const Home: React.FC<HomeProps> = ({ onOpenAuth }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-[#005A8D] py-20 lg:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 w-full max-w-lg">
              <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 transform hover:scale-[1.01] transition-transform duration-300">
                <h3 className="text-2xl font-bold text-gray-800 mb-6 font-serif">Para onde vamos?</h3>
                
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                      <MapPin size={16} className="text-brand-blue" /> Destino
                    </label>
                    <input 
                      required
                      type="text" 
                      ...
                      className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-brand-blue focus:border-brand-blue outline-none transition-all"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                        <Calendar size={16} className="text-brand-blue" /> Dias
                      </label>
                      <input 
                        required
                        type="number" 
                        ...
                        className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-brand-blue outline-none"
                      />
                    </div>
                    <div className="space-y-1">
                       <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                        <Users size={16} className="text-brand-blue" /> Quem vai?
                      </label>
                      <select 
                        value={travelers}
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                      <DollarSign size={16} className="text-brand-blue" /> Orçamento
                    </label>
                  ...
                  <div className="space-y-1">
                     <label className="text-sm font-medium text-gray-700">Interesses (opcional)</label>
                     <input 
                        type="text" 
                        value={interests}
                        onChange={(e) => setInterests(e.target.value)}
                        placeholder="Ex: museus, praias, comida de rua..."
                        className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-brand-blue outline-none text-sm"
                      />
                  </div>
                  ...
                  <button 
                    type="submit"
                    disabled={loading}
                    className="w-full bg-brand-coral hover:bg-red-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-red-200 transition-all transform active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-serif font-bold text-gray-800 mb-4">Por que usar o ViajaIA?</h2>
            <p className="text-gray-600">Esqueça horas de pesquisa. Nossa inteligência artificial cria o plano perfeito baseado exatamente no que você gosta.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-slate-50 rounded-xl hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center text-brand-blue mb-4">
                <Globe size={24} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-800">Roteiros Globais</h3>
              <p className="text-gray-600">De mochilão na Tailândia a luxo em Paris, cobrimos qualquer destino com dicas locais.</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-xl hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center text-orange-600 mb-4">
                <DollarSign size={24} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-800">Controle de Gastos</h3>
              <p className="text-gray-600">Estimativas reais de custos diários para você viajar sem surpresas no cartão.</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-xl hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center text-green-600 mb-4">
                <ShieldCheck size={24} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-800">Segurança de Dados</h3>
              <p className="text-gray-600">Seus planos e preferências salvos com segurança. Em conformidade com a LGPD.</p>
            </div>
          </div>
        </div>
      </section>
