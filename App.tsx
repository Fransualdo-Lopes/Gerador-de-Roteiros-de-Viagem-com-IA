...
const AuthModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 md:p-8 relative animate-[fadeIn_0.3s_ease-out]">
        <button 
          onClick={onClose}
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-serif font-bold text-gray-800 mb-2">Crie sua conta</h2>
          <p className="text-gray-600">Em menos de 1 minuto, você salva e acessa seu roteiro personalizado.</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-blue focus:border-brand-blue outline-none"
              />
            </div>
          </div>
